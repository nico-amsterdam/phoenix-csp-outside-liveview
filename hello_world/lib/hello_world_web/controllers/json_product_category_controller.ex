defmodule HelloWorldWeb.JsonProductCategoryController do
  use HelloWorldWeb, :controller

  alias NimbleCSV.RFC4180, as: CSV
  alias HelloWorldWeb.MissingParameter
  ...
  def index(conn, params) do
    ...
    # json(conn, %{productcat: product_category_list})             # render without view HelloWorldWeb.JsonProductCategoryJSON.ex
